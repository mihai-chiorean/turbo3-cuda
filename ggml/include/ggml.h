...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TBQ4_0  = 43, // TurboBlockQuant 4-bit: 128-element blocks, rotation + 4-bit codebook
        GGML_TYPE_TBQ3_0  = 44, // TurboBlockQuant 3-bit: 128-element blocks, rotation + 3-bit codebook (3.125 bpw)
        GGML_TYPE_COUNT   = 45,
    };
