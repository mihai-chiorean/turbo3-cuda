...
extern void dequantize_row_tbq4_0_fp16_cuda(const void * vx, half * y, int64_t k, cudaStream_t stream);
extern void dequantize_row_tbq4_0_fp32_cuda(const void * vx, float * y, int64_t k, cudaStream_t stream);
extern void dequantize_row_tbq4_0_bf16_cuda(const void * vx, nv_bfloat16 * y, int64_t k, cudaStream_t stream);
extern void dequantize_row_tbq4_0_fp16_nc_cuda(const void * vx, half * y, int64_t ne00, int64_t ne01, int64_t ne02, int64_t ne03, int64_t s01, int64_t s02, int64_t s03, cudaStream_t stream);
